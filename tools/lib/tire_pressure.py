    ...
    for i, data_point in enumerate(data_points):
        ...
        if expected_speed > 0:
            ...
            for wheel, actual_speed in actual_wheel_speeds.items():
                deviation = (actual_speed - expected_speed) / expected_speed * 100
                deviations[wheel] = deviation - 100
...
if __name__ == "__main__":
    ...
    data_points = []
    for msg in [msg for msg in tqdm(MultiLogIterator(Route(log_path).log_paths()))]:
